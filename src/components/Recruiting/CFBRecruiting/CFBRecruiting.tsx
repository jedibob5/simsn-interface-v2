import { FootballArchetypeOptions, FootballPositionOptions, Help1, navyBlueColor, Overview, RecruitingRankings, RecruitingTeamBoard, SimCFB, StarOptions, StatusOptions } from "../../../_constants/constants";
...
export const CFBRecruiting = () => {
    ...
    const {
      ...
      const teamColors = useTeamColors(cfbTeam?.ColorOne, cfbTeam?.ColorTwo, cfbTeam?.ColorThree);
      ...
      const updatePointsOnRecruit = () => {};

      const SaveAIRecruitingSettings = async () => {}
      const SaveRecruitingBoard = async () =>{};
      return (
        <>
            {modalPlayer && (
            <ActionModal
                          ...
                          <div className="sm:grid sm:grid-cols-2 w-full">
                            <div className="flex flex-row w-full gap-x-6 justify-center sm:justify-normal">
                              <div className="flex flex-col">
                                <Text variant="body-small" classes="text-nowrap font-semibold">
                                  AI Active
                                </Text>
