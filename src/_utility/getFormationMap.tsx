export const FormationMap = {
  "Power Run": {
    ...
    Notes:
      "This scheme centers around using the run to set up the pass. Most run-heavy pro scheme, but still a good amount of passing will be available.",
  },
  Vertical: {
    Formations: [
      {
    ...
    Notes:
      "This scheme centers on the long pass, but still allows for quite a bit of running.",
  },
  "West Coast": {
    Formations: [
      {
    ...
    Notes:
      "This scheme centers on the short pass, but still allows for a bit of running.",
  },
  "I Option": {
    Formations: [
      {
    ...
    Notes:
      "This scheme offers up the ability to run a lot more option-type plays, but still is mainly balanced in run vs. pass.",
  },
  "Run and Shoot": {
    Formations: [
      {
    ...
    Notes:
      "This scheme focuses on short passes and passes far more often than it runs.",
  },
  "Air Raid": {
    Formations: [
      {
    ...
    Notes:
      "This scheme focuses on long passes and passes far more often than it runs.",
  },
  Pistol: {
    Formations: [
      {
    ...
    Notes:
      "This scheme is the most balanced of the spread offenses and has limited access to option-type plays.",
  },
  "Spread Option": {
    Formations: [
      {
    ...
    Notes:
      "This scheme offers up the ability to run a lot more option-type plays, but focuses on pass plays still.",
  },
  "Wing-T": {
    Formations: [
      {
    ...
    Notes:
      "This scheme has the most balanced approach (run vs. pass) of the smashmouth scheme group.",
  },
  "Double Wing": {
    Formations: [
      {
  ...
  Wishbone: {
    ...
    Notes:
      "This scheme is also fairly balanced (run vs. pass) like the Wing-T, but it does not have access to any shotgun formations.",
  },
  Flexbone: {
    Formations: [
      {
    ...
    Notes:
      "This scheme offers up the ability to run a lot more option-type plays, but is almost entirely run-focused.",
  },
  "Old School": {
    Formations: [
      {
  ...
  "2-Gap": {
    ...
    BadFits: ["Speed Rusher DE", "Pass Rusher DT", "Speed OLB", "Speed ILB"],
